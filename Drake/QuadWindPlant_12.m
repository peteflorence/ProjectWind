classdef QuadWindPlant_12 < DrakeSystem
  ...
  methods
    ...
    function [xdot,df] = dynamics(obj,t,x,u)
      ...
      windout = obj.quadwind(quadpos,1,t); % pass mytime to quadwind. % last arument is plot option
    ...
    function wind = quadwind(obj,quadpos,plotme, t)
