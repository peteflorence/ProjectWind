classdef CrazyflieWindModelCpp12 < DrakeSystem
  ...
  methods
    function obj = CrazyflieWindModelCpp12()
      ...
      obj = setStateFrame(obj,CoordinateFrame('CrazyFlie13State',12,'x',{'x','y','z','roll','pitch','yaw','xdot','ydot','zdot','rolldot','pitchdot','yawdot'}));
    ...
    function [xdot,dxdot] = dynamics_helper(obj,t,x,u)
      ...
      tempfunc = @(t, x, u) obj.Cf_dynamics_no_grad12(t, x, u);
